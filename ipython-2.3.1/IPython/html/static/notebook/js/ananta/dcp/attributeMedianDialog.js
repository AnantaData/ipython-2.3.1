...
var IPython = (function (IPython) {
    ...
    /**
     * The constructor of Attribute Median Dialog, this class is extended from ProfileDialog
     * @param cell_id
     * @param step_no
     * @constructor
     */
    var AttrMedianDialog = function (cell_id,step_no ) {
        IPython.ProfileDialog.apply(this, [cell_id]);
        this.cell_id = cell_id;
        this.step_type = "atrMedn";
        this.step_show_name = "Attribute Median";
     ...
     */
    AttrMedianDialog.prototype = new IPython.ProfileDialog();
     ...
     * @param profile
     */
    AttrMedianDialog.prototype.show_dialog = function (profile) {
     ...
     */
    AttrMedianDialog.prototype.setInstruction = function(){
        this.documentation.text('Specify a median value and tick the respective field/s that should be filled with the given median value'+
        '.')
    };
     ...
     */
    AttrMedianDialog.prototype.build_elements = function (profile) {


        var div = $('<div/>');

        this.stepNameInp_id = this.dialog_id+"stepname";
        //this.medianNameInp_id = this.dialog_id+"median";
        ...
        //var attrNameLbl = $('<label for="stepname">Attribute Median:</label>');
        //var medianNameInp = $('<input type="text" name="stepname"  />');
        var statTabl = $('<table>' +
        ...
        //medianNameInp.attr('id',this.medianNameInp_id);
     ...
     */
    AttrMedianDialog.prototype.retrive_elements = function(){
        this.stepNameInp = $('#'+this.stepNameInp_id);
        //this.attrMedianInp = $('#'+this.medianNameInp_id);
     ...
     * @param profile
     */
    AttrMedianDialog.prototype.get_values = function(profile){
        ...
        //stepData.attr_median=this.attrMedianInp.val();
     ...
     * @param profile
     */
    AttrMedianDialog.prototype.set_values =function(profile){
        var stepData = {
            step_no : this.step_no,
            step_type : this.step_type,
            //attr_median : '',
        ...
        //this.attrMedianInp.val(stepData.attr_median);
     ...
     * @returns {Array}
     */
    AttrMedianDialog.prototype.getCheckedValues = function(){
        var fields = [];
     ...
     * @param fields
     */
    AttrMedianDialog.prototype.setCheckedValues = function(profile,fields){
        var checked = [];
     ...
     * @param this_dialog
     */
    AttrMedianDialog.prototype.addStep =function(profile, this_dialog){
     ...
     */
    AttrMedianDialog.prototype.set_dynamic_ui =function(){
    };
     ...
     * @type {Function}
     */
    IPython.AttrMedianDialog = AttrMedianDialog;
